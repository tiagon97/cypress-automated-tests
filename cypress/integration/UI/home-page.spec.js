...
describe("Home page", () => {
  it.only("Verifies home page content", function () {
    cy.visit("/");
  ...
  it("Verifies if articles are loaded correctly", () => {
    ...
    onHomePage
      ...
      .and("contain.text", "This description comes from my-articles.json file")
  ...
  it("Verifies if tags are loaded correctly", function () {
    ...
    onHomePage.getTagsSidebar().find(".tag-default").should("have.length", 7);
  });
});
